...
project = 'Contents Service Patterns'
...
latex_documents = [
  ('index', 'CSP.tex', 'CSP Documentation',
   'WineSOFT Inc.', 'manual'),
]
...
texinfo_documents = [
  ('index', 'CSP', 'CSP Documentation',
   'WOOSIK MOON', 'CSP', 'Contents Service Patterns.',
   'Miscellaneous'),
]
